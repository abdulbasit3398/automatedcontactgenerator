			...
			<div class="card plan-box">
				<div class="card-body p-4">
					...
					<div class="text-center plan-btn">
						...
						<a href="#" onclick="cart(event.preventDefault())" class="btn btn-primary btn-sm waves-effect waves-light upload-modal-button" >Cart</a>
					</div>
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-body">
					...
					<div id="carouselExampleFade1" class="carousel slide carousel-fade1" data-ride="carousel">
						<ol class="carousel-indicators">
              <li data-bs-target="#carouselExampleFade1" data-bs-slide-to="0" class="active"></li>
              <li data-bs-target="#carouselExampleFade1" data-bs-slide-to="1"></li>
            </ol>
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-body">
					...
					<div id="carouselExampleFade2" class="carousel slide carousel-fade1" data-ride="carousel">
						<ol class="carousel-indicators">
              <li data-bs-target="#carouselExampleFade2" data-bs-slide-to="0" class="active"></li>
              <li data-bs-target="#carouselExampleFade2" data-bs-slide-to="1"></li>
            </ol>
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-body">
					...
					<div id="carouselExampleFade3" class="carousel slide carousel-fade1" data-ride="carousel">
						<ol class="carousel-indicators">
		...
		<div class="col-xl-4 col-md-6">
			<div class="card">
				<div class="card-body">
					...
					<div id="carouselExampleFade21" class="carousel slide carousel-fade1" data-ride="carousel">
						<ol class="carousel-indicators">
